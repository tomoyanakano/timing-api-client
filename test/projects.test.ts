...
describe("ProjectsResource", () => {
  ...
  describe("create", () => {
    ...
    test("should create a sub-project", async () => {
      ...
      expect(mockedAxios.post).toHaveBeenCalledWith("/projects", {
        // Expect snake_case (parent is already snake_case like)
        title: "Sub Project",
        parent: "/projects/123",
      });
      expect(result).toEqual(expectedProject);
  ...
  describe("update", () => {
    test("should update a project", async () => {
      ...
      expect(mockedAxios.put).toHaveBeenCalledWith(`/projects/${id}`, {
        // Expect snake_case
        title: "Updated Project",
        notes: "Updated notes",
      });
    ...
    test("should update a project color", async () => {
      ...
      expect(mockedAxios.put).toHaveBeenCalledWith(`/projects/${id}`, {
        // color is already snake_case like
        color: "#00FF00",
      });
      expect(result).toEqual(expectedProject);
    });
